...
import numpy as np
import colorsys
from uma_mot.application_util.image_viewer import ImageViewer
...
class NoVisualization(object):
    ...
    def __init__(self, seq_info, detections, iou):
...
class Visualization(object):
    ...
    def __init__(self, seq_info, detections, iou, update_ms):
